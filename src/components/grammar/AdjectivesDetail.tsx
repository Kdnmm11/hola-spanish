    ...
    <div className="flex flex-col lg:flex-row gap-12 max-w-7xl mx-auto px-6 lg:px-8 py-8 font-sans text-slate-800 bg-white">
      ...
      <article className="flex-1 min-w-0">
          ...
          <section id="sec-1" className="mb-12 scroll-mt-24">
            ...
            <div className="overflow-hidden border border-slate-200 rounded-lg shadow-sm mb-6">
                <table className="w-full text-base border-collapse text-left table-fixed">
                    <thead className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200 text-sm uppercase">
                        <tr>
                            <th className="px-5 py-3 w-1/4 border-r border-slate-100">유형</th>
                            <th className="px-5 py-3 w-1/4 border-r border-slate-100 text-center">남성 단수</th>
                            <th className="px-5 py-3 w-1/4 border-r border-slate-100 text-center">여성 단수</th>
                            <th className="px-5 py-3 text-center">복수형</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100 bg-white text-[15px]">
                        {AGREEMENT_RULES.map((row, i) => (
                            <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td className="px-5 py-4 text-center font-medium border-r border-slate-100"><ColorEnd word={row.m_sg} type="m" /></td>
                                <td className="px-5 py-4 text-center font-medium border-r border-slate-100"><ColorEnd word={row.f_sg} type="f" /></td>
            ...
            <div className="p-5 bg-slate-50 border border-slate-200 rounded-xl shadow-sm flex gap-4 items-start">
          ...
          <section id="sec-2" className="mb-12 scroll-mt-24">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8 text-[15px]">
                <div className="border border-slate-200 rounded-xl p-5 shadow-sm">
                    ...
                    <p className="text-[14px] text-slate-600 mb-3 font-medium">객관적 사실, 색상, 국적</p>
                ...
                <div className="border border-slate-200 rounded-xl p-5 shadow-sm">
                    ...
                    <p className="text-[14px] text-slate-600 mb-3 font-medium">주관적 평가, 강조, 고유 속성</p>
                    <div className="bg-slate-50 p-3 rounded flex flex-col gap-1">
            ...
            <div className="overflow-hidden border border-slate-200 rounded-lg shadow-sm">
                <table className="w-full text-[15px] text-left border-collapse table-fixed">
                    <thead className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200 text-sm uppercase">
                        <tr>
                            <th className="px-5 py-3 w-[20%] border-r border-slate-100 text-center">형용사</th>
                            <th className="px-5 py-3 w-[40%] border-r border-slate-100 text-center text-slate-800">명사 앞 (주관)</th>
                            <th className="px-5 py-3 w-[40%] text-center text-slate-600">명사 뒤 (객관)</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100 bg-white font-medium">
                        {POSITION_MEANING.map((row, i) => (
                            <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                                <td className="px-5 py-4 font-bold text-slate-900 bg-slate-50/30 border-r border-slate-100 text-center">{row.adj}</td>
                                <td className="px-5 py-4 text-slate-900 border-r border-slate-100 text-center">{row.pre}</td>
                                <td className="px-5 py-4 text-slate-900 text-center">{row.post}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
          ...
          <section id="sec-3" className="mb-12 scroll-mt-24">
            ...
            <div className="overflow-hidden border border-slate-200 rounded-lg shadow-sm">
                <table className="w-full text-[15px] text-left border-collapse table-fixed">
                    <thead className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200 text-sm uppercase">
                        <tr>
                            <th className="px-5 py-3 w-1/4 border-r border-slate-100">원래 형태</th>
                            <th className="px-5 py-3 w-1/4 border-r border-slate-100 text-center">단축 형태</th>
                    ...
                    <tbody className="divide-y divide-slate-100 bg-white font-medium">
                        {SHORTENING_RULES.map((item, i) => (
                            <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                                <td className="px-5 py-4 font-bold text-slate-400 bg-slate-50/30 border-r border-slate-100">{item.adj}</td>
                                <td className="px-5 py-4 font-black text-slate-900 text-lg tracking-tight border-r border-slate-100 text-center">{item.rule}</td>
