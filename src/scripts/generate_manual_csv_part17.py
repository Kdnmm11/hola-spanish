...
manual_data = [
    {
        "문장": "De niño, ( ) tener un perro.",
        "단어원형": "querer, 원하다",
        "정답": "quería",
        "번역": "어렸을 때, 나는 개를 키우고(가지고) [싶었다].",
        "시제및단서": "[불완전과거] 과거의 지속적인 소망입니다."
    },
    {
        "문장": "Mañana ( ) las maletas en el coche.",
        "단어원형": "poner, 놓다/싣다",
        "정답": "pondré",
        "번역": "내일 나는 차에 짐을 [실을 것이다].",
        "시제및단서": "[미래] 내일의 계획입니다."
    },
    {
        "문장": "Ayer ( ) muy temprano de la oficina.",
        "단어원형": "salir, 나가다/퇴근하다",
        "정답": "salí",
        "번역": "어제 나는 사무실에서 매우 일찍 [나왔다].",
        "시제및단서": "[점과거] 어제 완료된 행위입니다."
    },
    {
        "문장": "No creo que él ( ) nadar.",
        "단어원형": "saber, 알다/할줄알다",
        "정답": "sepa",
        "번역": "나는 그가 수영할 줄 [안다고] 생각하지 않는다.",
        "시제및단서": "[접속법 현재] 의심/부정 표현입니다."
    },
    {
        "문장": "El año pasado, ( ) mi casa.",
        "단어원형": "vender, 팔다",
        "정답": "vendí",
        "번역": "작년에 나는 집을 [팔았다].",
    ...
    {
        "문장": "Si ( ) tiempo, iría al gimnasio.",
        "단어원형": "tener, 가지다",
        "정답": "tuviera",
        "번역": "시간이 [있다면], 헬스장에 갈 텐데.",
