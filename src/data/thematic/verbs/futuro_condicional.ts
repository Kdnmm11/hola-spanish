...
export const condicionalData: TenseDetail = {
    ...
    usage: [
        ...
        { situ: '과거에 대한 추측', ex: 'serían las diez cuando 그가 왔다.', ko: '그가 왔을 때는 아마 10시쯤이었을 것이다.' }
    ],
    regular: {
    ...
    irregularGroups: [
        {
            cat: '어간 변화 (d 추가 계열)',
            verbs: [
                { v: 'tener', mean: '가졌을 것이다', forms: { yo: ['tendr', 'ía'], tu: ['tendr', 'ías'], el: ['tendr', 'ía'], nos: ['tendr', 'íamos'], vos: ['tendr', 'íais'], ellos: ['tendr', 'ían'] } },
                { v: 'poner', mean: '놓았을 것이다', forms: { yo: ['pondr', 'ía'], tu: ['pondr', 'ías'], el: ['pondr', 'ía'], nos: ['pondr', 'íamos'], vos: ['pondr', 'íais'], ellos: ['pondr', 'ían'] } },
                { v: 'salir', mean: '나갔을 것이다', forms: { yo: ['saldr', 'ía'], tu: ['saldr', 'ías'], el: ['saldr', 'ía'], nos: ['saldr', 'íamos'], vos: ['saldr', 'íais'], ellos: ['saldr', 'ían'] } },
                { v: 'venir', mean: '왔을 것이다', forms: { yo: ['vendr', 'ía'], tu: ['vendr', 'ías'], el: ['vendr', 'ía'], nos: ['vendr', 'íamos'], vos: ['vendr', 'íais'], ellos: ['vendr', 'ían'] } }
            ]
        },
        {
            cat: '어간 변화 (e 탈락 계열)',
            verbs: [
                { v: 'poder', mean: '할 수 있었을 것이다', forms: { yo: ['podr', 'ía'], tu: ['podr', 'ías'], el: ['podr', 'ía'], nos: ['podr', 'íamos'], vos: ['podr', 'íais'], ellos: ['podr', 'ían'] } },
                { v: 'saber', mean: '알았을 것이다', forms: { yo: ['sabr', 'ía'], tu: ['sabr', 'ías'], el: ['sabr', 'ía'], nos: ['sabr', 'íamos'], vos: ['sabr', 'íais'], ellos: ['sabr', 'ían'] } },
                { v: 'querer', mean: '원했을 것이다', forms: { yo: ['querr', 'ía'], tu: ['querr', 'ías'], el: ['querr', 'ía'], nos: ['querr', 'íamos'], vos: ['querr', 'íais'], ellos: ['querr', 'ían'] } }
            ]
        },
        {
            cat: '어간 변화 (축약 계열)',
            verbs: [
                { v: 'hacer', mean: '했을 것이다', forms: { yo: ['har', 'ía'], tu: ['har', 'ías'], el: ['har', 'ía'], nos: ['har', 'íamos'], vos: ['har', 'íais'], ellos: ['har', 'ían'] } },
                { v: 'decir', mean: '말했을 것이다', forms: { yo: ['dir', 'ía'], tu: ['dir', 'ías'], el: ['dir', 'ía'], nos: ['dir', 'íamos'], vos: ['dir', 'íais'], ellos: ['dir', 'ían'] } }
            ]
        }
    ]
};
